var Helper = {
    ...
    isCollision: function (otherObj) {
        var leftAirplane = AIRPLANE[0].offsetLeft;
        var topAirplane = AIRPLANE[0].offsetTop;

        var leftOther = otherObj[0].offsetLeft;
        var topOther = otherObj[0].offsetTop;
    ...
    setHash: function (sizeTimer, sizeStar, sizeFuel, sizeRanking, isMuted) {
        window.location.hash = 'sizeTimer='+ sizeTimer +'&sizeStar='+ sizeStar +'&sizeFuel='+ sizeFuel +'&sizeRanking='+ sizeRanking +'&isMute='+ isMuted;
    }
};
